...
//		rb.useGravity = true;
	...
	void Update(){
		killCountText.text = enemyManager.enemies.Count.ToString();
...
//			jump.Play();
	...
	void OnCollisionEnter(Collision coll){
		if(coll.gameObject.name.Contains("food")){
			if(enemyManager.enemies.Contains(coll.gameObject)){
				enemyManager.enemies.Remove(coll.gameObject);
				coll.gameObject.SetActive(false);
				humansEaten++;
				GetComponent<PitchShifter>().PlayEatSound();
			}
		}
	}
